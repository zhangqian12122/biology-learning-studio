...
function PlatypusSvg({ active }: { active: number | null; open?: boolean }) {
  return (
    <svg viewBox="0 0 520 380" className="h-full w-full" aria-hidden="true">
      ...
      <g style={dim(active, 2)}>
        <text x="176" y="352" textAnchor="middle" fontSize="12" fill="#5a4a2a" fontWeight="600">幼崽舔食母兽腹部沟槽渗出的乳汁（无乳头）</text>
      </g>
...
export const ATLAS_CATEGORIES: { name: string; icon: string; ids: string[] }[] = [
  ...
  { name: '人体与调节', icon: '🩺', ids: ['redBloodCell', 'neuron', 'synapse', 'antibody', 'homeostasisNetwork', 'internalEnvironment', 'thermoregulation', 'monoclonalAntibody', 'threeDefenseLines', 'waterSaltBalance', 'bat', 'platypus'] },
